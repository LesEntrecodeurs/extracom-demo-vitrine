    ...
    <div>
      ...
      {isLoading ? (
        ...
        <ul className="card divide-y divide-neutral-100">
          {docs.map((d) => {
            const href = `/compte/commandes/${encodeURIComponent(d.id)}${
            ...
            return (
              <li key={d.id}>
                <Link
                  href={href}
                  className="flex items-center justify-between gap-4 p-4 transition-colors hover:bg-neutral-50 focus-visible:bg-neutral-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--brand)]"
                >
